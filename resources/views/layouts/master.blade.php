...
<html lang="en" data-textdirection="ltr" class="loading">
  ...
  <body data-open="click" data-menu="vertical-menu" data-col="2-columns" class="vertical-layout vertical-menu 2-columns  fixed-navbar">
      ...
      <div class="main-menu-content">
        <ul id="main-menu-navigation" data-menu="menu-navigation" class="navigation navigation-main">
          <li class=" nav-item"><a href="index.html"><i class="icon-home3"></i><span data-i18n="nav.dash.main" class="menu-title">Dashboard</span><span class="tag tag tag-primary tag-pill float-xs-right mr-2">2</span></a>
            ...
            <li class=" nav-item"><a href="#"><i class="icon-stack-2"></i><span data-i18n="nav.page_layouts.main" class="menu-title">Teacher</span></a>
            <ul class="menu-content">
              <li><a href="{{ route('index_teacher')}}" data-i18n="nav.page_layouts.1_column" class="menu-item">Teacher list</a>
              </li>
              <li><a href="{{ route('create_teacher')}}" data-i18n="nav.page_layouts.2_columns" class="menu-item">Create Teacher</a>
              </li>
              
            </ul>
          </li>

          <li class=" nav-item"><a href="#"><i class="icon-stack-2"></i><span data-i18n="nav.page_layouts.main" class="menu-title">Task</span></a>
            <ul class="menu-content">
              <li><a href="{{ route('index_task')}}" data-i18n="nav.page_layouts.1_column" class="menu-item">Task list</a>
              </li>
              <li><a href="{{ route('create_task')}}" data-i18n="nav.page_layouts.2_columns" class="menu-item">Create Task</a>
              </li>
              
            </ul>
          </li>

          <li class=" nav-item"><a href="#"><i class="icon-stack-2"></i><span data-i18n="nav.page_layouts.main" class="menu-title">Mail Sent</span></a>
            <ul class="menu-content">
              <li><a href="{{ route('mail_create')}}" data-i18n="nav.page_layouts.1_column" class="menu-item">mail create</a>
              </li>
    ...
    <footer class="footer footer-static footer-light navbar-border">
      <p class="clearfix text-muted text-sm-center mb-0 px-2"><span class="float-md-left d-xs-block d-md-inline-block">Copyright  &copy; 2018 <a href="https://themeforest.net/user/pixinvent/portfolio?ref=pixinvent" target="_blank" class="text-bold-800 grey darken-2">PIXINVENT </a>, All rights reserved. </span><span class="float-md-right d-xs-block d-md-inline-block">Hand-crafted & Made with <i class="icon-heart5 pink"></i></span></p>
    </footer>
